...
// const car = new Car('брэнд','модель','год');
// console.log(car);
...
// 			let yearCar = this.year;
// 			return yearNow - yearCar;
// 		}
// 	}
...
// 	const rectangle2 = new Rectangle('Ширина', 'Высота');
...
// const circle = new Circle('Радиус');
// console.log(circle);
...
// const student = new Student('имя','лет','оценка');
// console.log(student);
...
// const account2 = new BankAccount(balance);
// console.log(account2.deposit(sum));
...
// const account3 = new BankAccount(99);
...
// const animal2= new Animal('животное','звук');
...
// const calculator = new Calculator(100,5);
...
// const person = new Person('имя',18,'город');
// console.log(person);
...
// const person2 = new Person('город');
...
// const employee = new Employee('имя','позиция','зарплата');
...
// const employee2 = new Employee(1000);
...
// const square = new Square('сторона');
// console.log(square);
